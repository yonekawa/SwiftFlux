...
#if swift(>=3)
    public func == <T: Equatable, Error: Equatable> (_ left: Result<T, Error>, right: Result<T, Error>) -> Bool {
...
#if swift(>=3)
    public func ?? <T, Error> (_ left: Result<T, Error>, right: @autoclosure() -> T) -> T {
...
#if swift(>=3)
    public func ?? <T, Error> (_ left: Result<T, Error>, right: @autoclosure() -> Result<T, Error>) -> Result<T, Error> {
...
#if swift(>=3)
    public func >>- <T, U, Error> (_ result: Result<T, Error>, transform: @noescape(T) -> Result<U, Error>) -> Result<U, Error> {
